...
public class ExternalSocketF  extends PortCptFourni{

	public ExternalSocketF(String nom, ArrayList<ServiceCpt> serviceCS, ArrayList<PortCpt> portCpt, String nom1,
